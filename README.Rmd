...
bibliography: vignette/bibliography.bib
---
...
The goal of netseer is to predict the graph structure including new nodes and edges from a time series of graphs. The methodology is explained in the preprint  [@kand2024graphpred]. We will illustrate an example in this vignette. 
